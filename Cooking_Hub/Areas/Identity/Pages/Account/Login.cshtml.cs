        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
               ...
               */
                ...
                if (users == null) {
                    ModelState.AddModelError(string.Empty, "Please Register Email ");
                    return Page();
                }
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        // Assuming you want to redirect to the "Index" action of the "AspNetRolesController" in the "Admins" area
                    ...
                    {
                        // User has the "User" role, redirect to userindex.cshtml
